...
<?php
    ...
    if ($lookuppage=='indexlist'){
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo '<select id="stat'. $row['ID'] .'" class="'.$dayclass.' ui-corner-left indexstatus" name="newstatus" >';
            ...
            //////////     CYCLIST   DROPDOWN     ///////////////////////////////////
            echo '
            <select name="newcyclist" id="cyc'. $row['ID'] .'" class="'.$dayclass.' ui-corner-left indexrider';
