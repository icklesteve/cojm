...
<fieldset><label class="fieldLabel"> Show COJM Debug info </label>
...
<fieldset><label class="fieldLabel"> Test Joomla Login </label>
...
<fieldset><label class="fieldLabel"> Currency </label> &<? echo $globalprefrow['currencysymbol']; ?></fieldset>
...
<input type="checkbox" id="glob11" name="glob11" value="1" <?php if ($globalprefrow['glob11']=='1') { echo 'checked';} ?>></fieldset>



	
<fieldset><label class="fieldLabel"> Cyclist / Rider </label> 
...
<fieldset><label class="fieldLabel"> No <?php echo $globalprefrow['glob5']; ?> or Postcode </label> 
...
<fieldset><label class="fieldLabel"> Awaiting Scheduling Annoying Sound 
</label>
...
<fieldset><label class="fieldLabel"> Cycling Icon for Google Earth
...
<fieldset><label class="fieldLabel"> Default New Postcode Town </label>
<input type="text" class="ui-state-default ui-corner-all pad" size="15" name="glob3" value="<?php echo $globalprefrow['glob3']; ?>"></fieldset>

<fieldset><label class="fieldLabel"> Default New Postcode Locality </label>
