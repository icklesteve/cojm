...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			...
			{text: '2012', dateStart: '01/01/12', dateEnd: '31/12/12' },
			{text: '2013', dateStart: '01/01/13', dateEnd: '31/12/13' },
			{text: '2012 & 2013', dateStart: '01/01/12', dateEnd: '31/12/13' }
		], 
...
$(function() {var showText='Waypoints';
      var hideText='Waypoints';var is_visible = false;$('.toggle').prev().append(' (<a href="#" style="color:brown;" class="toggleLink">'+showText+'</a>)');$('.toggle').hide();$('a.toggleLink').click(function() {is_visible = !is_visible;$(this).html( (!is_visible) ? showText : hideText);$(this).parent().next('.toggle').toggle('fast');return false;
});

$("div#toggleaww").hide();
$("div#allowww").mouseover(function(){$("div#allowww").css({"cursor":"pointer"});});
$("div#allowww").click(function(){$("div#toggleaww").toggle("fast");});

$("div#toggledww").hide();
$("div#allowdww").mouseover(function(){$("div#allowdww").css({"cursor":"pointer"});});
$("div#allowdww").click(function(){$("div#toggledww").toggle("fast");});

$("div#toggleresume").hide();
$("div#toggleresumechoose").mouseover(function(){$("div#toggleresumechoose").css({"cursor":"pointer"});});
$("div#toggleresumechoose").click(function(){$("div#toggleresume").toggle("fast");});
});
    ...
    if(updateTime == 0){ $("span[id=cdtext]").html('<div style="background:red; color:black;" class="cojmsearch">PAGE HAS TIMED OUT FOR NEW CHANGES</div>'); }
    if(updateTime == 180){ $("span[id=cdtext]").html('<div style="" class="cojmsearch">Page Timing out next few mins</div>'); }
	if(updateTime == 92){ $("span[id=cdtext]").html('<div style="background:#941848; color:white;" class="cojmsearch">Page Timing Out Soon</div>'); }
	if(updateTime == 60){ $("span[id=cdtext]").html('<div style="background:#d51111; color:white;" class="cojmsearch">PAGE TIMING OUT VERY SOON <span id="cdnum"></div>'); }
