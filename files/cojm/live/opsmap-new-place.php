...
if ($sumtot>'0') { while ($row = mysql_fetch_array($sql_result)) { extract($row); 
...
?>	  
			...
			'<input type="text" name="pName" class="save-name ui-state-default ui-corner-all w170" placeholder="Enter Title" maxlength="40" value="<?php echo $opsname; ?>" /></div>'+
            '<div class="fs"><div class="fsli"> Info</div>'+
			'<textarea name="pDesc" class="save-desc w170 normal ui-state-highlight ui-corner-all " placeholder="Comments" maxlength="150">'+
...
var point     = new google.maps.LatLng(". $initiallat.','.$initiallon.");
...
<div id="map-canvas" class="onehundred" ></div></div></div>'; 
