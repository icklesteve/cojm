...
if ($table_select[0]=="Orders") { 

if ($backupruntype=="run2.php") { $query=$query.' ORDER BY ts desc '; } else {   $query.=' ORDER BY ID ASC ';  }  
 }
...
$buffer.=$alter_tables;        
// $recordBackup->save(time(), strlen($buffer), $lines_exported, $backupdescription);
