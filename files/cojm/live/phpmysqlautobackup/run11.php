...
$backupruntype="run11.php";
$backupdescription=" Weekly every Job Backup Pt 9, 16001-18000 ";
...
$limit_from='16001'; //record number to start from - IF YOU ARE NOT SURE LEAVE AS IS
$limit_to  ='18000'; //total rows to export - IF YOU ARE NOT SURE LEAVE AS IS
