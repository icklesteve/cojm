...
$backupruntype="run12.php";
$backupdescription=" Weekly every Job Backup Pt 10, 18001-20000 ";
...
$limit_from='18001'; //record number to start from - IF YOU ARE NOT SURE LEAVE AS IS
$limit_to  ='20000'; //total rows to export - IF YOU ARE NOT SURE LEAVE AS IS
