...
$backupruntype="run2.php";
$backupdescription=" Half Hourly backup of Job Tickets ";
...
$limit_to='1000 '; //total rows to export - IF YOU ARE NOT SURE LEAVE AS IS
