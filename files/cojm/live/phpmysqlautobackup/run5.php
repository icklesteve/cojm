...
$backupruntype="run5.php";
$backupdescription=" Weekly every Job Backup Pt 3, 4001-6000 ";
...
$limit_to='4001 '; //total rows to export - IF YOU ARE NOT SURE LEAVE AS IS
$limit_from='6000'; //record number to start from - IF YOU ARE NOT SURE LEAVE AS IS
