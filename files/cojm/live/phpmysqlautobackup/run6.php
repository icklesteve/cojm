...
$backupruntype="run6.php";
$backupdescription=" Weekly every Job Backup Pt 4, 6001-8000 ";
...
$limit_to='6001 '; //total rows to export - IF YOU ARE NOT SURE LEAVE AS IS
$limit_from='7500'; //record number to start from - IF YOU ARE NOT SURE LEAVE AS IS
