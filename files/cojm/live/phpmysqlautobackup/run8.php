...
$backupruntype="run8.php";
$backupdescription=" Weekly every Job Backup Pt 6, 10001-12000 ";
...
$limit_from='10001'; //record number to start from - IF YOU ARE NOT SURE LEAVE AS IS
$limit_to  ='12000'; //total rows to export - IF YOU ARE NOT SURE LEAVE AS IS

define('BALOCATION', realpath(dirname(__FILE__)) ."/files/");
define('LOCATION', realpath(dirname(__FILE__)) ."/files/");
 
//  $infotext.= ' <br /> in run8.php  ';
